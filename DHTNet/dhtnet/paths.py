...
"""
PLEASE READ readme.md FOR INFORMATION TO HOW TO SET THIS UP
"""
base = os.environ['DHTNet_raw_data_base'] if "DHTNet_raw_data_base" in os.environ.keys() else "/home/xiexie/data/LiTS/data_raw/"
preprocessing_output_dir = os.environ['DHTNet_preprocessed'] if "DHTNet_preprocessed" in os.environ.keys() else "/home/xiexie/data/LiTS/data_preprocessed/"
network_training_output_dir_base = os.path.join(os.environ['RESULTS_FOLDER']) if "RESULTS_FOLDER" in os.environ.keys() else "/home/xiexie/data/LiTS/"


if base is not None:
    DHTNet_raw_data = join(base, "DHTNet_raw_data")
    DHTNet_cropped_data = join(base, "DHTNet_cropped_data")
    maybe_mkdir_p(DHTNet_raw_data)
    maybe_mkdir_p(DHTNet_cropped_data)
else:
    ...
    DHTNet_cropped_data = DHTNet_raw_data = None
