...
from dhtnet.experiment_planning.common_utils import get_pool_and_conv_props_poolLateV2
from dhtnet.experiment_planning.utils import create_lists_from_splitted_dataset
from dhtnet.network_architecture.Generic_nnUNet import Generic_UNet
from dhtnet.paths import *
from dhtnet.preprocessing.cropping import get_case_identifier_from_npz
from dhtnet.training.model_restore import recursive_find_python_class
...
class ExperimentPlanner(object):
    ...
    def run_preprocessing(self, num_threads):
        ...
        preprocessor_class = recursive_find_python_class([join(dhtnet.__path__[0], "preprocessing")],
                                                         self.preprocessor_name, current_module="dhtnet.preprocessing")
...
if __name__ == "__main__":
    ...
    for i in task_ids:
        i = int(i)
        candidates = subdirs(DHTNet_cropped_data, prefix="Task%03.0d" % i, join=False)
    ...
    for t in tasks:
        try:
            ...
            splitted_4d_output_dir_task = os.path.join(DHTNet_raw_data, t)
