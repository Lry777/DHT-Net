...
import dhtnet
from dhtnet.paths import network_training_output_dir, preprocessing_output_dir, default_plans_identifier
from batchgenerators.utilities.file_and_folder_operations import *
from dhtnet.experiment_planning.summarize_plans import summarize_plans
...
def get_default_configuration(network, task, network_trainer, plans_identifier=default_plans_identifier,
                              search_in=(dhtnet.__path__[0], "training", "network_training"),
                              base_module='dhtnet.training.network_training'):
    ...
    output_folder_name = join(network_training_output_dir, task, network_trainer + "__" + plans_identifier)
