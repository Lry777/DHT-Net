...
from dhtnet.training.default_configuration import get_default_configuration
from dhtnet.paths import default_plans_identifier
from dhtnet.training.load_pretrained_weights import load_pretrained_weights
...
def main():
    ...
    trainer_class = TrainerV2

    if trainer_class is None:
        raise RuntimeError("Could not find trainer class in dhtnet.training.network_training")
