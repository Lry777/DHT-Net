...
import shutil
from dhtnet.paths import default_cascade_trainer, default_plans_identifier, default_trainer, network_training_output_dir
...
def export_entry_point():
    ...
    parser.add_argument('-pl', type=str, help='dhtnet plans identifier. Default: %s' % default_plans_identifier,
